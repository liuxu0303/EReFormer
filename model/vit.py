...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=(224, 224), patch_size=16, in_chans=5, embed_dim=1024):
        super().__init__()
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, model_name='vit_base_patch16_224', img_size=(224, 224), patch_size=16, in_chans=5, embed_dim=768, depth=12,
                 num_heads=12, num_classes=1, mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0.1, attn_drop_rate=0.,
                 drop_path_rate=0.,  norm_layer=partial(nn.LayerNorm, eps=1e-6), norm_cfg=None,
    ...
    def init_weights(self, pretrained=None):
        ...
        if not self.random_init:
            print('Initialize weight from vit_base_patch16_224')
    ...
    def forward(self, x):
        ...
        for i, blk in enumerate(self.blocks):
            ...
            if i in self.out_indices:
                outs.append(x)
        return tuple(outs), self.pos_embed
