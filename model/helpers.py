...
def load_pretrained(model, cfg=None, num_classes=1000, in_chans=3, filter_fn=None, strict=True, pos_embed_interp=False, num_patches=576, align_corners=False):
    ...
    state_dict = torch.load('../ETMD-depth/model/vit-pretrain/vit_base_p16_224-4e355ebd.pth')
    print('load pre-trained weight from ' + '../ETMD-depth/model/vit-pretrain/vit_base_p16_224-4e355ebd.pth')
